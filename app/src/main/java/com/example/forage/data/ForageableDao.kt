...
interface ForageableDao {
    ...
    @Query("SELECT * FROM foragable")
    fun getAll(): Flow<List<Forageable>>

    @Query("SELECT * FROM foragable WHERE id = :id")
    fun getById(id:Long): Flow<Forageable>
    ...
    @Delete
    suspend fun delteForageable(forageable: Forageable)
}
